 ...
 * 
 */
public class DatabaseStakingBalanceCompareMain {
  private static final Logger LOGGER = LogManager.getLogger(DatabaseStakingBalanceCompareMain.class);
  ...
  public static void main(String[] args) {
    try {
      ...
      DatabaseStakingBalanceCompare databaseStakingBalanceChecker = new DatabaseStakingBalanceCompare();

      databaseStakingBalanceChecker.checkStakingBalance(stakingBalanceHelper);
      databaseStakingBalanceChecker.checkYieldmachineDFIBalance(yieldmachineBalanceHelper);
      databaseStakingBalanceChecker.checkYieldmachineDUSDBalance(yieldmachineBalanceHelper);
