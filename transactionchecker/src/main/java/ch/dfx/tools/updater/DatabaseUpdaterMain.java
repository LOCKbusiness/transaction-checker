 ...
 * 
 */
public class DatabaseUpdaterMain {
  private static final Logger LOGGER = LogManager.getLogger(DatabaseUpdaterMain.class);

  // ...
  private static final String IDENTIFIER = "databaseupdater";
  ...
  public static void main(String[] args) {
    try {
      ...
      // ...
      DatabaseUpdater databaseUpdater = new DatabaseUpdater(databaseManager);
