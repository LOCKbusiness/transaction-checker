...
public class TransparencyReportCsvHelper {
  ...
  private static final DecimalFormat US_DECIMAL_FORMAT = new DecimalFormat("#,###.00000000", US_DECIMAL_FORMAT_SYMBOLS);
...
//  }
   ...
   * 
   */
  public HistoryAmountSheetDTOList readHistoryAmountSheetDTOFromCSV(@Nonnull Set<Integer> historyHourSet) throws DfxException {
    ...
    try (BufferedReader reader = new BufferedReader(new FileReader(historyAmountFile))) {
      ...
      while (null != (line = reader.readLine())) {
        ...
        if (historyHourSet.isEmpty()
          ...
          historyAmountSheetDTO.setTimestamp(entryArray[0]);
          ...
          for (TokenEnum token : TokenEnum.values()) {
            // TODO: currently without EUROC, coming later ...
            if (TokenEnum.EUROC != token) {
              historyAmountSheetDTO.put(
                  token,
                  BigDecimal.valueOf(US_DECIMAL_FORMAT.parse(entryArray[i++]).doubleValue()).setScale(8, RoundingMode.HALF_UP));
            }
          }
   ...
   * 
   */
  public HistoryInterimDifferenceSheetDTOList readHistoryInterimDifferenceSheetDTOFromCSV(@Nonnull Set<Integer> historyHourSet) throws DfxException {
    ...
    try (BufferedReader reader = new BufferedReader(new FileReader(historyInterimDifferenceFile))) {
      ...
      while (null != (line = reader.readLine())) {
        ...
        if (historyHourSet.isEmpty()
          ...
          historyInterimDifferenceSheetDTO.setTimestamp(entryArray[0]);
          ...
          for (TokenEnum token : TokenEnum.values()) {
            // TODO: currently without EUROC, coming later ...
            if (TokenEnum.EUROC != token) {
              historyInterimDifferenceSheetDTO.put(
                  token,
                  BigDecimal.valueOf(US_DECIMAL_FORMAT.parse(entryArray[i++]).doubleValue()).setScale(8, RoundingMode.HALF_UP));
            }
          }
   ...
   * 
   */
  public HistoryAssetPriceSheetDTOList readHistoryAssetPriceSheetDTOFromCSV(@Nonnull Set<Integer> historyHourSet) throws DfxException {
    ...
    try (BufferedReader reader = new BufferedReader(new FileReader(historyAssetPriceFile))) {
      ...
      while (null != (line = reader.readLine())) {
        ...
        if (historyHourSet.isEmpty()
          ...
          historyAssetPriceSheetDTO.setTimestamp(entryArray[0]);
   ...
   * 
   */
  public HistoryPriceSheetDTOList readHistoryPriceSheetDTOFromCSV(@Nonnull Set<Integer> historyHourSet) throws DfxException {
    ...
    try (BufferedReader reader = new BufferedReader(new FileReader(historyPriceFile))) {
      ...
      while (null != (line = reader.readLine())) {
        ...
        if (historyHourSet.isEmpty()
          ...
          historyPriceSheetDTO.setTimestamp(entryArray[0]);
