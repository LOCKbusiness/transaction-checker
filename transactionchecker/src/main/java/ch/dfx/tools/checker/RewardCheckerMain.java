 ...
 * 
 */
public class RewardCheckerMain {
  private static final Logger LOGGER = LogManager.getLogger(RewardCheckerMain.class);

  private static final String IDENTIFIER = "reward-checker";
  ...
  public static void main(String[] args) {
    try {
      ...
      // ...
      RewardChecker rewardChecker = new RewardChecker(network, databaseBlockHelper, databaseBalanceHelper);
      rewardChecker.check(connection);
