  ...
  public void invalidCreateVaultTest() {
    ...
    try {
      doInvalidTest(
          ...
          "[Transaction] ID: 7604d78bdb4bc72125ec5b8a7faf19bc434fc9ac31c0ba5f9dd7e00e3061c200 - invalid vout address");
      ...
      doInvalidTest(
          ...
          "[Transaction] ID: 7604d78bdb4bc72125ec5b8a7faf19bc434fc9ac31c0ba5f9dd7e00e3061c200 - invalid custom address");
    } catch (Exception e) {
      fail("no exception expected: " + e.getMessage());
    }
  }
  ...
  public void invalidDepositToVaultTest() {
    ...
    try {
      doInvalidTest(
          ...
          "[Transaction] ID: 7a348073524fb60f87a07e626da8960eeeca15c01237f327dc44ed6fa4b3b7b1 - invalid vout address");
      ...
      doInvalidTest(
          ...
          "[Transaction] ID: 7a348073524fb60f87a07e626da8960eeeca15c01237f327dc44ed6fa4b3b7b1 - invalid custom address");

      doInvalidTest(
          "json/yieldmaschine/good/03-API-DepositToVault.json",
          "json/yieldmaschine/good/03-DC-Transaction.json",
          "json/yieldmaschine/invalid/03-DC-CustomTransaction-wrong-vaultid.json",
          "invalidDepositToVaultTest-signature-3",
          "[Transaction] ID: 7a348073524fb60f87a07e626da8960eeeca15c01237f327dc44ed6fa4b3b7b1 - invalid vault id");
    } catch (Exception e) {
      fail("no exception expected: " + e.getMessage());
    }
  }
  ...
  public void invalidWithdrawFromVaultTest() {
    ...
    try {
      doInvalidTest(
          ...
          "[Transaction] ID: 2622c830c9005b8de22282ab2801e5ce7ee7773e87e2a8e339704234e455b106 - invalid vout address");
      ...
      doInvalidTest(
          ...
          "[Transaction] ID: 2622c830c9005b8de22282ab2801e5ce7ee7773e87e2a8e339704234e455b106 - invalid custom address");

      doInvalidTest(
          "json/yieldmaschine/good/04-API-WithdrawFromVault.json",
          "json/yieldmaschine/good/04-DC-Transaction.json",
          "json/yieldmaschine/invalid/04-DC-CustomTransaction-wrong-vaultid.json",
          "invalidWithdrawFromVaultTest-signature-3",
          "[Transaction] ID: 2622c830c9005b8de22282ab2801e5ce7ee7773e87e2a8e339704234e455b106 - invalid vault id");
    } catch (Exception e) {
      fail("no exception expected: " + e.getMessage());
    }
  }
  ...
  public void invalidTakeLoanTest() {
    ...
    try {
      doInvalidTest(
          ...
          "[Transaction] ID: 2a4386b8ea235c9e76d4f1b907a12686297475143684f37cbede4c2c0864ee04 - invalid vout address");
      ...
      doInvalidTest(
          ...
          "[Transaction] ID: 2a4386b8ea235c9e76d4f1b907a12686297475143684f37cbede4c2c0864ee04 - invalid custom address");

      doInvalidTest(
          "json/yieldmaschine/good/05-API-TakeLoan.json",
          "json/yieldmaschine/good/05-DC-Transaction.json",
          "json/yieldmaschine/invalid/05-DC-CustomTransaction-wrong-vaultid.json",
          "invalidTakeLoanTest-signature-3",
          "[Transaction] ID: 2a4386b8ea235c9e76d4f1b907a12686297475143684f37cbede4c2c0864ee04 - invalid vault id");
    } catch (Exception e) {
      fail("no exception expected: " + e.getMessage());
    }
  }
  ...
  public void invalidPaybackLoanTest() {
    ...
    try {
      doInvalidTest(
          ...
          "[Transaction] ID: 0a8761b329082913c5ed359f40c7d440cbc8d367a588c488a871d60e303715a6 - invalid vout address");
      ...
      doInvalidTest(
          ...
          "[Transaction] ID: 0a8761b329082913c5ed359f40c7d440cbc8d367a588c488a871d60e303715a6 - invalid custom address");

      doInvalidTest(
          "json/yieldmaschine/good/06-API-PaybackLoan.json",
          "json/yieldmaschine/good/06-DC-Transaction.json",
          "json/yieldmaschine/invalid/06-DC-CustomTransaction-wrong-vaultid.json",
          "invalidPaybackLoanTest-signature-3",
          "[Transaction] ID: 0a8761b329082913c5ed359f40c7d440cbc8d367a588c488a871d60e303715a6 - invalid vault id");
    } catch (Exception e) {
      fail("no exception expected: " + e.getMessage());
    }
  }
  ...
  public void invalidPoolAddLiquidityTest() {
    ...
    try {
      doInvalidTest(
          ...
          "[Transaction] ID: 431e43dde6fa1534dc8299ad898556b5b149f90a0ecaccbc1a06e093a5f3933c - invalid vout address");
      ...
      doInvalidTest(
          ...
          "[Transaction] ID: 431e43dde6fa1534dc8299ad898556b5b149f90a0ecaccbc1a06e093a5f3933c - invalid custom address");
    } catch (Exception e) {
      fail("no exception expected: " + e.getMessage());
    }
  }
  ...
  public void invalidPoolRemoveLiquidityTest() {
    ...
    try {
      doInvalidTest(
          ...
          "[Transaction] ID: a7641e494c07b2543a78348dae81aa9eacf1a4be45173dbc5a4d353ab5fc1a18 - invalid vout address");
      ...
      doInvalidTest(
          ...
          "[Transaction] ID: a7641e494c07b2543a78348dae81aa9eacf1a4be45173dbc5a4d353ab5fc1a18 - invalid custom address");
    } catch (Exception e) {
      fail("no exception expected: " + e.getMessage());
    }
  }
