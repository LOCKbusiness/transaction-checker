 ...
 * 
 */
public class APIHistoryMain {
  private static final Logger LOGGER = LogManager.getLogger(APIHistoryMain.class);
  ...
  public static void main(String[] args) {
    try {
      ...
      // ...
      String liquidityAddress = "xxxxx";
      String depositAddress = "yyyyy";
      String customerAddress = "zzzzz";

      // ...
      APIHistory apiHistory = new APIHistory(network, databaseBlockHelper);
      apiHistory.checkDeposit(connection, liquidityAddress, depositAddress);
      apiHistory.checkWithdrawal(connection, liquidityAddress, customerAddress);
